...
// $train = new train;
//         $train->train_name= $_POST['name'];
//         $train->source= $_POST['source'];
//         $train->destination = $_POST['destination'];
//         $train->arrival_time = $_POST['arrival'];
//         $train->departure_time = $_POST['departure'];
//         $train->train_no = $_POST['number'];
//         $trainController->addtrain($train);


if (isset($_POST['name']) && isset($_POST['source']) && isset($_POST['destination'])  && isset($_POST['departure']) && isset($_POST['number']) ) {
    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <div class="tab-pane fade show active " id="account" role="tabpanel" aria-labelledby="account-tab">
                        <h3 class="mb-4">Train Settings</h3>
                        <?php
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">Train</h3>
